...
namespace La3endak.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TestimonialId,UserId,Rating,Text,CreatedDate,CreatedTime")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("TestimonialId,UserId,Rating,Text,CreatedDate,CreatedTime")] Testimonial testimonial)
        {
