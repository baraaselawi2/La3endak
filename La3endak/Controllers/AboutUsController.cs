...
namespace La3endak.Controllers
{
    public class AboutUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AboutId,Txt,ImagePath")] AboutU aboutU)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("AboutId,Txt,ImagePath")] AboutU aboutU)
        {
